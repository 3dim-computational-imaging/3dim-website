...
sections:
  - block: markdown
    ...
    content:
      ...
      text: |
        {{< figure src="3DIM_Apr26_FINAL.jpg" library="true" class="project-section-wrap-image" width="700px" max_width="50%" caption="The 3DIM Lab in April 2026. [Click here](/people) to see the current roster of lab members." >}}
        ...
        Current applications of our developed techniques and systems can be found in medicine, VR/AR/MR, robotics, industrial inspection, remote sensing, automotive sensing, metrology, forensics, or cultural heritage preservation. Our present research includes novel techniques to [image hidden objects through scattering media](/projects/swi/), multimodal imaging approaches for the high-accuracy 3D measurement of challenging mixed reflectance surfaces in [industrial inspection](/projects/industrialinspection/) and [medical imaging](/projects/medical3dimaging/), [unconventional methods for precise VR eye-tracking](/projects/eyetracking/), [computational spectroscopy techniques for semiconductor thin film characterization](/projects/thinfilm/), and novel methods for [wavefront control in holographic light engines and in optical free-space communication](/projects/ao/).
  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        The work shown on this website has been generously funded by the agencies and industry partners listed below. Prof. Willomitzer was directly awarded funding as Principal Investigator (PI) or Co-Principal Investigator (Co-PI) from NSF, NIH, AFOSR, NCMS, NEH, OPTICA, Meta, Texas Instruments, Amazon, and MAGNA.
